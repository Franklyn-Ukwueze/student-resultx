...
def add_new_student(name = ""):
    ...
    if name:
        ...
        subjects = list(input("Enter students subjects here, seperated by ',' then press ENTER\n"))
...
def update_score(student_name):
    """
    Updates score of student provided and prints new details to screen.
    """
